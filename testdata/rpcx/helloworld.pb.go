...
var fileDescriptor_17b8c58d586b62f2 = []byte{
	...
	0xcb, 0xa4, 0xc4, 0xb0, 0xc8, 0x14, 0xe4, 0x54, 0x2a, 0x31, 0x38, 0x49, 0x9f, 0x78, 0x24, 0xc7,
	0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb, 0x31, 0x44, 0x71, 0xc2,
	0x94, 0xa6, 0x24, 0xb1, 0x81, 0xbd, 0x61, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x19, 0x3c, 0xa9,
	0xd3, 0xda, 0x00, 0x00, 0x00,
}
...
const _Greeter_serviceName = "Greeter"
...
func ServeForGreeter(addr string) error {
	s := server.NewServer()
	s.RegisterName(_Greeter_serviceName, new(GreeterImpl), "")
	return s.Serve("tcp", addr)
}

func RegisterGreeterServe(s *server.Server, srv GreeterAble, metadata string) error {
	return s.RegisterName(_Greeter_serviceName, srv, metadata)
}
...
func NewXClientForGreeter(addr string) (client.XClient, error) {
	...
	xclient := client.NewXClient(_Greeter_serviceName, client.Failtry, client.RoundRobin, d, opt)
...
func NewGreeterOneClient(oneclient client.OneClient) *GreeterOneClient {
	return &GreeterOneClient{
		serviceName: _Greeter_serviceName,
		oneclient:   oneclient,
	}
}
